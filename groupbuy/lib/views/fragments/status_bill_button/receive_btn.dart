...
class ReceiveBillPage extends StatefulWidget {
  const ReceiveBillPage({Key? key}) : super(key: key);
  static const String routeName = '/billInfo';
  @override
  State<ReceiveBillPage> createState() => _ReceiveBillPageState();
}

class _ReceiveBillPageState extends State<ReceiveBillPage> {
