...
class DeliveryBillPage extends StatefulWidget {
  const DeliveryBillPage({Key? key}) : super(key: key);
  static const String routeName = '/billInfo';
  @override
  State<DeliveryBillPage> createState() => _DeliveryBillPageState();
}

class _DeliveryBillPageState extends State<DeliveryBillPage> {
